...
class Recipe:
    ...
    def add_recipe(self):
        ...
        try:
            ...
            milk = int(
                input("Enter the amount of Milk(mls) (if no Milk is used enter 0): \n")
            )
            butter = int(
                input(
                    "Enter the amount of Butter(g) (if no Butter is used enter 0): \n")
            )
            flour = int(
                input("Enter the amount of Flour(g) (if no Flour is used enter 0): \n")
            )
            sugar = int(
                input("Enter the amount of Sugar(g) (if no Sugar is used enter 0): \n")
            )
            chocolate = int(
                input(
                    "Enter the amount of Chocolate(g) (if no Chocolate is used enter 0): \n")
            )
            vanilla = int(
                input(
                    "Enter the amount of Vanilla(mls) (if no Vanilla is used enter 0): \n")
            )
            bake_time = int(
                input("Enter the Bake time(mins) (if no bake time is used enter 0): \n")
            )
        except ValueError:
            print(
